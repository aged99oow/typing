...
NON_WORD = ' -.,\'":;/!?$0123456789'
PROPER_NOUN = (
    'Ben', 'Daniel', 'Nancy', 'Greg', 'Kate', 'Robert', 'Richard', 'Angela', 'Arthur', 'Gary', 
    'Cindy', 'Yoshio', 'Clara', 'Kenji', 'Mary', 'Anne', 'Jack', 'Laura', 'Tom', 'Kent', 
    'Kazuo', 'Nick', 'John', 'Dorothy', 'Paul', 'Auster', 'Barcelona', 'Denis', 'Hiroko', 'Hiroshi', 
    'Mayumi', 'Bill', 'Sean', 'Jimmy', 'Tadashi', 'Dennis', 'Smith', 'Harvard', 'Taro', 'Hiromi', 
    'Emmy', 'Susan', 'Paul', 'Linda', 'Lucy', 'Cinderella', 'Matt', 'Nelson', 'Beth', 'Steve',
    'Hisashi', 'Dave', 'Yumi', 'Jim', 'Nile', 'Dublin', 'Peru', 'Katherine', 'Akiko', 'karate', 
    'Miki', 'Brian', 'Sam', 'Celsius', 'Suzuki', 'Sara', 'Tanaka', 'Bob', 'Ginza', 'Hokkaido', 
    'Los Angeles', 'Lisa', 'karate', 'Ted', 'Sally', 'Kevin', 'Hawaii', 'New York', 'Dick', 'London', 
    'Tokyo', 'Osaka', 'Nakagawa', 'California', 'Titanic', 'Haruko', 'Asia', 'Australia', 'Hilary', 'Michael', 
    'South Carolina', 'Ichiro', 'Harry', 'Cathy', 'Sue', 'San Diego', 'Las Vegas', 'Eliza', 'Gifu', 'Brown', 
    'Keiko', 'New Zealand', 'Amanda', 'CD', 'PC', 'TV', 'Jenny', 'Satsuki', 'Universal Studios Japan', 
    'Brazil', 'Yuko', 'Mozart', 'Korea', 'Jill', 'Tommy', 'Randy', 'Jones', 'Judy', 'Jane', 'Sherlock Holmes', 
    'George Orwell', 'Jessica', '', 
)
HINT_RATE = 8
...
class App:
    def set_hint(self):
        ...
        for w in PROPER_NOUN:  # Proper Noun
